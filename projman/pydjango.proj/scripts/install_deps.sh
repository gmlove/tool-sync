...
SYS_DEPS=(python-pip build-essential python-dev libxml2-dev mysql-server mysql-client python-mysqldb gcc libxslt-dev)
PYTHON_DEPS=("django==1.4" "uwsgi==1.2.3" "sqlalchemy==0.7.8" lxml)
